...
The raw candidate resume dataset (`candidates.jsonl`, ~465 MB) is excluded from this repository. Place it in the **parent directory** of the repository:
...
# 2. Run full pipeline (all 4 precompute stages + ranking)
python rank.py --candidates ../candidates.jsonl --out ../submission.csv
